...
------------------------------------- */
h1,h2,h3,h4,h5,h6 {
font-family: "HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif; line-height: 1.1; margin-bottom:15px; color:black;
}
h1 small, h2 small, h3 small, h4 small, h5 small, h6 small { font-size: 60%; color: #fff; line-height: 0; text-transform: none; }
									...
									<table align="left">
										<tr>
											<td>				
												...
												<h5 class="">Informações de Atvidade:</h5>
												<p class="">
												<p>
													<b>Usuário:</b> <?=$usuário?><br/>
													<b>IP: </b><?=$ip?> <br/>
													<b>Agente do Usuário: </b><?=$agent?> <br/>
                                                    <b>Atividade: </b><?=$atividade?> <br/>
                                                    <b>Descrição da Atividade: </b><?=$descricao_atividade?> <br/>
												</p>
